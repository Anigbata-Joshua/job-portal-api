...
import { validate, createCompanySchema, updateCompanySchema, addRecruiterSchema } from '../middleware/validation.middleware.js';
...
router.post('/:id/recruiters', authenticate, validate(addRecruiterSchema), addRecruiter);
